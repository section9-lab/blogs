import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{r as a,o as t,c as r,d as e,b as s,w as l,e as n,f as v}from"./app-b8bed171.js";const c={},u=e("h1",{id:"cka",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#cka","aria-hidden":"true"},"#"),n(" CKA")],-1),m={class:"table-of-contents"},b=v(`<hr><h2 id="_1、考点说明" tabindex="-1"><a class="header-anchor" href="#_1、考点说明" aria-hidden="true">#</a> 1、考点说明</h2><p>CKA认证考试中的权重：</p><ul><li>集群架构，安装和配置：25%</li><li>工作负载和调度：15%</li><li>服务和网络：20%</li><li>存储：10%</li><li>故障排除：30%</li></ul><h2 id="_2、操作系统准备" tabindex="-1"><a class="header-anchor" href="#_2、操作系统准备" aria-hidden="true">#</a> 2、操作系统准备</h2><h3 id="_2-1、安装虚拟机软件" tabindex="-1"><a class="header-anchor" href="#_2-1、安装虚拟机软件" aria-hidden="true">#</a> 2.1、安装虚拟机软件</h3><blockquote><p>我的电脑是一台16G的macbook-pro，需要在电脑上安装一款虚拟机软件，然后在虚拟机上运行多台Linux服务器。</p></blockquote><table><thead><tr><th>虚拟机软件</th><th>支持的操作系统</th><th>说明</th></tr></thead><tbody><tr><td>vmware</td><td>mac win linux</td><td>提供收费和免费版</td></tr><tr><td>VirtualBox</td><td>mac win linux</td><td>个人和企业版均免费</td></tr><tr><td>Hyper-V</td><td>win</td><td>Windows子系统(WSL)安装Linux</td></tr><tr><td>Multipass</td><td>mac win linux</td><td>轻量、快速、支持命令行</td></tr><tr><td>Parallels Desktop</td><td>mac</td><td>Mac下使用Windows体验较好，收费</td></tr><tr><td>UTM</td><td>mac</td><td>M系列花片模批x86架构，基于QEMU</td></tr><tr><td>QEMU</td><td>mac win linux</td><td>模拟不同指令集架构</td></tr></tbody></table><p>相比于vmware和VirtualBox，Multipass更加的轻量快捷</p><p>安装<code>multipass</code></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>brew <span class="token function">install</span> multipass
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-3、镜像操作系统的配置设定" tabindex="-1"><a class="header-anchor" href="#_1-3、镜像操作系统的配置设定" aria-hidden="true">#</a> 1.3、镜像操作系统的配置设定</h2><ul><li>密码配置</li></ul><p>设置密码（镜像默认没有密码）<br> sudo passwd ubuntu</p><ul><li>设置静态ip</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#备份配置
...
modprobe -- nf_conntrack
EOF
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-4、安装容器" tabindex="-1"><a class="header-anchor" href="#_1-4、安装容器" aria-hidden="true">#</a> 1.4、安装容器</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#containerd下载
...
#查看版本：
containerd --version
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-5、安装k8s" tabindex="-1"><a class="header-anchor" href="#_1-5、安装k8s" aria-hidden="true">#</a> 1.5、安装k8s</h2><ul><li>1.5.1、设置镜像源</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#创建目录
sudo mkdir -p /etc/apt/keyrings/
#下载密钥
curl -fsSL https://pkgs.k8s.io/core:/stable:/v1.31/deb/Release.key | sudo gpg --dearmor -o /etc/apt/keyrings/kubernetes-apt-keyring.gpg
#添加kubernetes apt仓库
echo &#39;deb [signed-by=/etc/apt/keyrings/kubernetes-apt-keyring.gpg] https://pkgs.k8s.io/core:/stable:/v1.31/deb/ /&#39; | sudo tee /etc/apt/sources.list.d/kubernetes.list
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>1.5.2、安装<code>kubelet</code> <code>kubeadm</code> <code>kubectl</code></li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>apt clean &amp;&amp; rm -rf /var/lib/apt/lists/* &amp;&amp; apt update
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-6、集群初始化" tabindex="-1"><a class="header-anchor" href="#_1-6、集群初始化" aria-hidden="true">#</a> 1.6、集群初始化</h2><p>生成配置文件：<br> kubeadm config print init-defaults &gt; kubeadm-config.yaml</p><p>修改配置文件：<br> vim kubeadm-config.yaml</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1、修改master在集群中的名称
nodeRegistration:
...
root@k8s-master:~#
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-7、安装网络插件-只在master执行" tabindex="-1"><a class="header-anchor" href="#_1-7、安装网络插件-只在master执行" aria-hidden="true">#</a> 1.7、安装网络插件(只在master执行)</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#创建配置文件 1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-8、安装nginx测试集群可用性" tabindex="-1"><a class="header-anchor" href="#_1-8、安装nginx测试集群可用性" aria-hidden="true">#</a> 1.8、安装nginx测试集群可用性</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>root@k8s-master:~# cat nginx.yaml
---
apiVersion: apps/v1
kind: Deployment
metadata:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>network test</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>╭─test@MacBook-Pro ~
...
&lt;/body&gt;
&lt;/html&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,71);function o(g,p){const i=a("router-link");return t(),r("div",null,[u,e("nav",m,[e("ul",null,[e("li",null,[s(i,{to:"#_1、考点说明"},{default:l(()=>[n("1、考点说明")]),_:1})]),e("li",null,[s(i,{to:"#_2、操作系统准备"},{default:l(()=>[n("2、操作系统准备")]),_:1}),e("ul",null,[e("li",null,[s(i,{to:"#_2-1、安装虚拟机软件"},{default:l(()=>[n("2.1、安装虚拟机软件")]),_:1})])])]),e("li",null,[s(i,{to:"#_2-2、在虚拟机上创建操作系统镜像"},{default:l(()=>[n("2.2、在虚拟机上创建操作系统镜像")]),_:1})]),e("li",null,[s(i,{to:"#_1-3、镜像操作系统的配置设定"},{default:l(()=>[n("1.3、镜像操作系统的配置设定")]),_:1})]),e("li",null,[s(i,{to:"#_1-4、安装容器"},{default:l(()=>[n("1.4、安装容器")]),_:1})]),e("li",null,[s(i,{to:"#_1-5、安装k8s"},{default:l(()=>[n("1.5、安装k8s")]),_:1})]),e("li",null,[s(i,{to:"#_1-6、集群初始化"},{default:l(()=>[n("1.6、集群初始化")]),_:1})]),e("li",null,[s(i,{to:"#_1-7、安装网络插件-只在master执行"},{default:l(()=>[n("1.7、安装网络插件(只在master执行)")]),_:1})]),e("li",null,[s(i,{to:"#_1-8、安装nginx测试集群可用性"},{default:l(()=>[n("1.8、安装nginx测试集群可用性")]),_:1})])])]),b])}const x=d(c,[["render",o],["__file","CKA.html.vue"]]);export{x as default};
