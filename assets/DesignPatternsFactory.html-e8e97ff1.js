import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as r,c,d as e,b as a,w as s,e as n,f as t}from"./app-68ff8460.js";const u={},v=e("h1",{id:"design-patterns-factory",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#design-patterns-factory","aria-hidden":"true"},"#"),n(" Design Patterns Factory")],-1),m={class:"table-of-contents"},o=t(`<hr><h1 id="一、创建型模式" tabindex="-1"><a class="header-anchor" href="#一、创建型模式" aria-hidden="true">#</a> 一、创建型模式：</h1><h2 id="_2、工厂模式" tabindex="-1"><a class="header-anchor" href="#_2、工厂模式" aria-hidden="true">#</a> 2、工厂模式</h2><h3 id="简单工厂" tabindex="-1"><a class="header-anchor" href="#简单工厂" aria-hidden="true">#</a> 简单工厂</h3><figure><img src="https://kroki.io/plantuml/svg/eNqlU81KAzEQvucp5liRBi966qGi9AFsb-JhSKZx2PyZTBVp67O73S3SQ-mu9BLCwPc7ybwKFtkEr2rDMWPBAAVjUynD_d3J0GaGh9NBRtOgoxWLp0fPLgaKAp7WopTxWCuYFLRQFW2wUtUhWfJ61Q6eKSTYqlvYturCZg-fiS0E5DhZSuHoXt9u1F5xFCprNHSeqr5jJr08nC3bT09iC35NDuALHnrgExfjqfMxGtmJLdBIKt8dsld3JN3l6H6U_AsZwej-6-AY-mOD5Ryy7X6oqtluOh3u5Xqev4DXU_Vx1eUHNdtpPby1MWbG8ICaU7Ttx_kFgWYoOQ==" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>─model
    │  ShapeFactory.java
    │  TestDemo.java
    │
    └─shape
