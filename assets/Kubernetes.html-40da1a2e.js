...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>[参考]</p>`,73),f={href:"https://kubernetes.io/zh-cn/docs/concepts/overview/",target:"_blank",rel:"noopener noreferrer"};function A(y,E){const t=a("CodeTabs"),u=a("ExternalLinkIcon");return v(),o("div",null,[h,l(t,{id:"315",data:[{id:"debian"},{id:"rpm"}],"tab-id":"shell"},{title0:i(({value:s,isActive:d})=>[n("debian")]),title1:i(({value:s,isActive:d})=>[n("rpm")]),tab0:i(({value:s,isActive:d})=>[g]),tab1:i(({value:s,isActive:d})=>[k]),_:1}),x,e("ul",null,[e("li",null,[e("a",f,[n("https://kubernetes.io/zh-cn/docs/concepts/overview/"),l(u)])])])])}const S=c(p,[["render",A],["__file","Kubernetes.html.vue"]]);export{S as default};
