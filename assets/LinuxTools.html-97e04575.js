import{_ as r}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as d,c,d as a,b as n,w as i,e as s,f as p}from"./app-3417b901.js";const o={},u=a("h1",{id:"linuxtools",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#linuxtools","aria-hidden":"true"},"#"),s(" LinuxTools")],-1),v={class:"table-of-contents"},m=p(`<hr><h2 id="压缩" tabindex="-1"><a class="header-anchor" href="#压缩" aria-hidden="true">#</a> 压缩</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>tar.gz格式
